...
<details className="advanced-section"><summary>Optional scheduling details</summary><div className="advanced-section-body">
...
<details className="advanced-section"><summary>Advanced completion and notes</summary><div className="advanced-section-body">
