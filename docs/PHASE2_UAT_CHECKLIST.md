...
| G. Missing Documents | Bills/payments with incomplete evidence exist | Open `/missing-documents` | Missing invoice, partial evidence, paid bill without payment slip and payment without payment reference counts are visible |  | Yes | Report is operational, not a full audit pack |
